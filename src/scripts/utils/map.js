...
export default class Map {
  ...
  constructor(selector, options = {}) {
    ...
    const satelliteLayer = tileLayer(
      `https://api.maptiler.com/tiles/satellite/{z}/{x}/{y}.jpg?key=${MAP_SERVICE_API_KEY}`,
      {
        attribution: '&copy; <a href="https://www.maptiler.com/" target="_blank">MapTiler</a>',
        maxZoom: 20,
        tileSize: 512,
        zoomOffset: -1,
      },
